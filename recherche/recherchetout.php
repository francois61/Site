<?php
		...
		if($blanc==1 && $noir==0){
		$resultats1=$bdd->query("SELECT * FROM joueur jou join partie par on jou.n_joueur=par.j_blanc join tournoi tou on par.tournoi=tou.n_tournoi where jou_NOM like '%$nom%' and jou_PRENOM like '%$prenom%' and tou.tour_NOM like '%$tournoi%' and tou.SITE like '%$lieu%'");
		...
		if($blanc == $noir){
			$resultats2=$bdd->query("SELECT * FROM joueur jou join partie par on jou.n_joueur=par.j_blanc join tournoi tou on par.tournoi=tou.n_tournoi where jou_NOM like '%$nom%' and jou_PRENOM like '%$prenom%' and tou.tour_NOM like '%$tournoi%' and tou.SITE like '%$lieu%'");
			...
			$resultats3=$bdd->query("SELECT * FROM joueur jou join partie par on jou.n_joueur=par.j_noir join tournoi tou on par.tournoi=tou.n_tournoi where jou_NOM like '%$nom%' and jou_PRENOM like '%$prenom%' and tou.tour_NOM like '%$tournoi%' and tou.SITE like '%$lieu%'");
		...
		if($blanc==0 && $noir==1){
		$resultats4=$bdd->query("SELECT * FROM joueur jou join partie par on jou.n_joueur=par.j_noir join tournoi tou on par.tournoi=tou.n_tournoi where jou_NOM like '%$nom%' and jou_PRENOM like '%$prenom%' and tou.tour_NOM like '%$tournoi%' and tou.SITE like '%$lieu%'");
